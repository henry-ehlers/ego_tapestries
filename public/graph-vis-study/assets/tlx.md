...
felt completing a task. It does that by measuring six demands, which can be set on a slider scale.

You can read about the six demands below. In the next tutorial part you will see the NASA TLX form, where you can move the sliders to indicate how strongly you felt about each demand.
